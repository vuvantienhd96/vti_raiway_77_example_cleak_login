...
function isFragment(child) {
  return child && isValidElement2(child) && child.type === React30.Fragment;
}
function replaceElement(element, replacement, props) {
  if (!isValidElement2(element)) {
    return replacement;
  }
  return React30.cloneElement(element, typeof props === "function" ? props(element.props || {}) : props);
}
...
var fullClone3 = _objectSpread2({}, ReactDOM2);
...
var WaveEffect = (props) => {
  ...
  const [color, setWaveColor] = React31.useState(null);
  const [borderRadius, setBorderRadius] = React31.useState([]);
  const [left, setLeft] = React31.useState(0);
  const [top, setTop] = React31.useState(0);
  const [width, setWidth] = React31.useState(0);
  const [height, setHeight] = React31.useState(0);
  const [enabled, setEnabled] = React31.useState(false);
  const waveStyle = {
    left,
    top,
    width,
  ...
  return React31.createElement(es_default, {
    visible: true,
    motionAppear: true,
...
var showWaveEffect = (target, info) => {
  ...
  render(React31.createElement(WaveEffect, Object.assign({}, info, {
    target
  })), holder);
};
...
var GroupSizeContext = React37.createContext(void 0);
var ButtonGroup = (props) => {
  ...
  return React37.createElement(GroupSizeContext.Provider, {
    value: size
...
var InternalButton = (props, ref) => {
  ...
  const needInserted = import_react21.Children.count(children) === 1 && !icon && !isUnBorderedButtonType(type);
  ...
  if (true) {
    ...
    true ? warning3(!(ghost && isUnBorderedButtonType(type)), "usage", "`link` or `text` button can't be a `ghost` button.") : void 0;
  }
  ...
  const classes = (0, import_classnames9.default)(prefixCls, hashId, {
...
*/
//# sourceMappingURL=chunk-SXM2ZKPX.js.map
